...
# Prefer packaged path (Lambda: /var/task/wisdom), then monorepo root
_CANDIDATE_ROOTS = [
    Path(__file__).resolve().parents[1] / "wisdom",  # backend/wisdom
    Path(__file__).resolve().parents[2] / "wisdom",  # repo/wisdom
    Path("/var/task/wisdom"),
]
